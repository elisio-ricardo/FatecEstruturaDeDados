		...
		do {
			...
			case 2: // disciplina
				do {
					...
					case 1:
						...
						break;
					case 2:
						id = Integer.parseInt(JOptionPane.showInputDialog("Digite o id do da Disciplina: "));
						...
						break;
					case 3:
						disciplina = dc.removeInicio();
						JOptionPane.showMessageDialog(null,
								"Disciplina deletado da lista: " + disciplina.getNomeDisciplina());
						break;
					case 4:
						disciplina = dc.removefinal();
						JOptionPane.showMessageDialog(null,
								"Disciplina deletado da lista: " + disciplina.getNomeDisciplina());
						break;
					case 5:
			...
			case 3: // media
				do {
					...
					case 1:
						...
						int idDisciplina = Integer.parseInt(JOptionPane.showInputDialog("Disciplinas disponíveis: "
						...
						break;
					case 2:
						idAluno = Integer.parseInt(JOptionPane.showInputDialog("Alunos disponíveis: \n"
								+ al.percorrer(0) + "\n Digite o id do aluno para cadastro da média: "));
						...
						idDisciplina = Integer.parseInt(JOptionPane.showInputDialog("Disciplinas disponíveis: "
								+ dc.percorrer(0) + "\n Digite o id da disciplina para cadastro da média: "));
						nomeAux = dc.retornaNome(idDisciplina);
						if (nomeAux == null) {
							System.out.println("Disciplina inválida");
			...
			case 4:
				...
				if (aux != null) {
					...
					aux = mediaSorted;
					while (aux != null) {
						System.out.println("Aluno: " + al.retornaNome(aux.media.getAlunoId()) + "| Disciplina: "
								+ dc.retornaNome(aux.media.getDisciplinaId()) + "| Média: "
								+ aux.media.getMediaFinal());
